        ...
        <aside
            ...
            <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="group sidebar-nav {{ request()->routeIs('admin.dashboard') ? 'sidebar-nav-active' : '' }}">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="group sidebar-nav {{ request()->routeIs('admin.users.*') ? 'sidebar-nav-active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.products.index') }}"
                    class="group sidebar-nav {{ request()->routeIs('admin.products.*') ? 'sidebar-nav-active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
